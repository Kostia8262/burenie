...
<section class="sec sec--s1 sec--blueprint" id="ceny">
  <div class="wrap split">
    <div>
      <h2 class="d2">Бурение — от <?= e(number_format(PRICE_DRILL_FROM, 0, ',', ' ')) ?> ₽ за метр</h2>
      <p class="lead">
        Это цена проходки в обычном грунте. В неё не входят обсадная труба,
        обустройство и насос — их считают отдельно, потому что они зависят от
        глубины и от того, какую воду вы хотите получить. Поэтому итоговую
        сумму мы называем после выезда, и дальше она уже не меняется.
      </p>
      <div class="prose">
